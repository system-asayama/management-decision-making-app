...
_BS_FIELD_GROUPS = [
    ...
    {'label': '純資産の部 / 2. 資本剰余金', 'options': ['capital_reserve', 'other_capital_surplus']},
    ...
    {'label': '参考：合計項目', 'options': ['quick_assets', 'current_assets', 'tangible_fixed_assets', 'fixed_assets', 'total_assets', 'current_liabilities', 'fixed_liabilities', 'total_liabilities', 'capital_surplus', 'retained_earnings', 'net_assets', 'total_liabilities_and_net_assets']},
]
