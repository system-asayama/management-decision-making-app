...
_BS_FIELD_GROUPS = [
    ...
    {'label': '負債の部 / 5. 借入金', 'options': ['short_term_borrowings', 'current_portion_long_term', 'long_term_borrowings']},
    {'label': '負債の部 / 6. その他流動負債・引当金', 'options': ['income_taxes_payable', 'bonus_reserve', 'other_allowances', 'other_current_liabilities', 'discounted_notes']},
    {'label': '負債の部 / 固定負債', 'options': ['executive_borrowings', 'retirement_benefit_liability', 'other_fixed_liabilities']},
