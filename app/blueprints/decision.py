    ...
    try:
        ...
        if request.method == 'POST':
            ...
            if post_type == 'bs':
                ...
                rbs.income_taxes_payable = pi('income_taxes_payable')
                rbs.bonus_reserve = pi('bonus_reserve')
                rbs.other_allowances = pi('other_allowances')
...
_PL_FIELD_GROUPS = [
    ...
    {'label': '2. 売上原価', 'options': ['beginning_inventory', 'beginning_inventory_material', 'beginning_inventory_wip', 'beginning_inventory_product', 'beginning_inventory_goods', 'manufacturing_cost', 'current_purchases', 'ending_inventory', 'ending_inventory_material', 'ending_inventory_wip', 'ending_inventory_product', 'ending_inventory_goods', 'cost_of_sales']},
...
_BS_FIELDS = {
    ...
    'other_tangible': '(6) その他',
    'tangible_fixed_assets': '有形固定資産合計',
    'intangible_fixed_assets': '2 無形固定資産',
    'investments_and_other': '3 投資その他の資産',
    'deferred_assets': 'III 繰延資産',
    'trade_payables': '(1) 買掛債務',
    'short_term_borrowings': '(2) 短期借入金',
    'current_portion_long_term': '5. 長期借入金（1年以内支払い）',
    'long_term_borrowings': '(1) 長期借入金（1年後支払い）',
    ...
    'other_fixed_liabilities': '(4) その他固定負債',
    'capital': '1 資本金',
    'capital_reserve': '(1) 資本準備金',
    'other_capital_surplus': '(2) その他資本剰余金',
    'capital_surplus': '2 資本剰余金',
    'legal_reserve_bs': '(1) 利益準備金',
...
_BS_FIELD_GROUPS = [
    ...
    {'label': '資産の部 / I 流動資産 / 2. 売掛債権', 'options': ['trade_receivables']},
    {'label': '資産の部 / I 流動資産 / 3. 棚卸資産', 'options': ['inventory_assets']},
    {'label': '資産の部 / I 流動資産 / 4. その他流動資産', 'options': ['other_current_assets']},
    ...
    {'label': '資産の部 / II 固定資産 / 2. 無形固定資産', 'options': ['intangible_fixed_assets']},
    {'label': '資産の部 / II 固定資産 / 3. 投資その他の資産', 'options': ['investments_and_other']},
    {'label': '資産の部 / III 繰延資産', 'options': ['deferred_assets']},
    {'label': '負債の部 / I 流動負債 / (1) 買掛債務', 'options': ['trade_payables']},
    {'label': '負債の部 / I 流動負債 / (2) 短期借入金', 'options': ['short_term_borrowings']},
    {'label': '負債の部 / I 流動負債 / (3)～(7) その他', 'options': ['discounted_notes', 'income_taxes_payable', 'bonus_reserve', 'other_allowances', 'other_current_liabilities']},
...
_FIXED_SUMMARY_ACCOUNT_NAMES = {
    ...
    '資産合計', '流動負債合計', '固定負債合計', '負債合計', '当期純損益金額',
    '資本金合計', '資本剰余金合計', '利益準備金合計',
