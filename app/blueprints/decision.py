...
_BS_FIELD_GROUPS = [
    ...
    {'label': '負債の部 / 流動負債 / (1) 買掛債務', 'options': ['trade_payables']},
    {'label': '負債の部 / 流動負債 / (2) 短期借入金', 'options': ['short_term_borrowings']},
    {'label': '負債の部 / 流動負債 / (3)～(7) その他', 'options': ['discounted_notes', 'income_taxes_payable', 'bonus_reserve', 'other_allowances', 'other_current_liabilities']},
